...
/**
 * Represents a pop-up UI screen shown when the player loses the game.
 * <p>
...
public class LoseScreen extends VBox {
    ...
    /** Text displaying the "You Lose" message along with score and time */
    ...
    /**
     * Constructs a LoseScreen and initializes its UI components.
     */
    public LoseScreen() {
